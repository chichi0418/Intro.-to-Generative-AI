...
export function ChatWindow({
  ...
  useEffect(() => {
    ...
    // Always scroll on new message; during streaming only scroll if already at bottom
  ...
  return (
    <div className="flex-1 overflow-hidden" style={{ position: 'relative' }}>
      ...
      <div ref={scrollRef} onScroll={handleScroll} className="h-full overflow-y-auto py-6">
        {messages.length === 0 && (
